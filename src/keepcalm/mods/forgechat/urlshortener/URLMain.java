...
import keepcalm.mods.forgechat.ForgeChatContainer;
...
public class URLMain {
	...
	public URLMain() {
		myMeta.version = "1.4.2-1";
		myMeta.name = "URL Shortener";
		myMeta.autogenerated = false;
		myMeta.authorList = Arrays.asList(new String[] {"keepcalm"});
		myMeta.credits = "DaringFireball.net";
		myMeta.parentMod = Loader.instance().getIndexedModList().get("ForgeChat_Dummy");
		ForgeChatContainer.registerChildMod(Loader.instance().getIndexedModList().get("URLShorten"));
	}
